...
<div class="success_content">
  <div class="success_left">
    ...
    <h3 align="center">添加书籍成功！</h3>
  </div>
  <div class="success_right">
    <p class="green16">您已成功添加书籍！</p>
    <p><a href="book.jsp"><span class="tn-button">继续添加书籍</span></a><a href="administrator.jsp"><span class="tn-button">退出</span></a></p>
  </div>
  <div class="clear"></div>
</div>
